...
CREATE TABLE `clientes` (
  ...
  UNIQUE KEY `RUT` (`RUT`),
  KEY `FK_clientes_ventas_idx` (`id_cliente`)
...
INSERT INTO `clientes` VALUES (6,'Paulo','Piñones','100245875','Camilo Henríquez 765','Recoleta','56956847898'),(2,'Manuel','Massini','112354785','Las Hualtatas 542','Vitacura','56925473657'),(1,'Romina','Rodríguez','123658954','Gibraltar 7106','La Reina','56987478254'),(7,'Catalina','Calderón','145879652','Camino el Alto 6987','Puente Alto','56954789652'),(3,'María','Manríquez','185247896','San Diego 254','Santiago','56965841235'),(4,'Bernardo','Bernales','205894751','Martín Lopez 4332','La Pintana','56936365418'),(5,'Macarerna','Molinares','225475684','Antigonish 5584','La Florida','56912477895');
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT `FK_clientes_ventas` FOREIGN KEY (`id_venta`) REFERENCES `clientes` (`id_cliente`),
  CONSTRAINT `FK_ventas_productos` FOREIGN KEY (`id_venta`) REFERENCES `productos` (`id_producto`)
...
-- Dump completed on 2023-05-11 21:07:24
